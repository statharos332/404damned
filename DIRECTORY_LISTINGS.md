# 🎯 404 DAMNED — Directory Listing Kit

Ready-to-paste copy for agency directories (Sortlist, DesignRush, GoodFirms,
Clutch, etc). Written to be honest and specific — same standard as the
website itself. **Don't add client counts, review quotes or metrics beyond
what's here.** Directories increasingly verify reviews by email; fabricated
ones get flagged and can get a profile rejected or delisted.

---

## Status

- **Clutch** — unclear if a listing actually exists under "404 DAMNED".
  Confirm the URL before doing anything else; don't create a duplicate.
- **Sortlist** — not listed yet. Free tier available.
- **DesignRush** — not listed yet. Manual approval, reviews the live site.
- **GoodFirms** — not listed yet. Also showed up in the competitor
  research; free tier available, worth doing alongside the other two.

---

## Sign-up links

- Sortlist: https://www.sortlist.com/claim/agency
- DesignRush: https://www.designrush.com/submit/agency
...
> that connect into a client's actual tools — CRM, inbox, spreadsheets —
> rather than sitting on the side as a chatbot demo.
>
...
Match these to whatever category picker the directory uses:

- Web Development (Next.js, React)
- E-Commerce Development (Shopify, Magento, WooCommerce, headless)
- AI Automation
- Branding & Identity
- SEO
- Social Media Management

## Fields likely to trip you up

- **"Year founded"** — some directories treat this as a hard fact, not a
...
- **Portfolio / case studies** — link directly to
  `https://www.404damned.com/work/skg-vip-transfers` and
  `https://www.404damned.com/work/etsyboost-ai` rather than re-uploading,
  where the directory allows it — keeps one source of truth.

## Team (for "Our Team" sections, if the directory has one)

- **Nick Grigoriadis** — Founder, Management & Project Management —
