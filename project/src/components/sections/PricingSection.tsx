...
const plans = [
  {
    ...
    price: "4.900",
    period: "one-time",
    description: "A professional digital presence that converts. Custom design, clean code, zero templates.",
    features: [
  ...
  },
  {
    ...
    description: "Complete digital weapon: custom development, AI automation and ongoing growth system.",
    features: [
      "Everything in Starter",
      "AI lead qualification system",
      "E-commerce or advanced integrations",
    ...
    cta: "Most ambitious brands pick this",
    featured: true,
  },
  {
    name: "Enterprise",
    tagline: "For market leaders in the making.",
    price: "Custom",
    period: "retainer",
    description: "Full-service digital partnership. We embed in your team and own your digital growth outcomes.",
    features: [
      "Everything in Growth",
      "Dedicated team (dev + design + strategy)",
      "Custom AI automation stack",
      "Multi-channel paid media",
      "Board-level digital strategy",
      "SLA with response guarantee",
      "Monthly exec reporting",
